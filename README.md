...
- `download_url` u manifestu upućuje na GitHub Releases `latest`. Za novi release:
  ...
  3. Tagujte verziju (npr. `v1.5.0`) i objavite GitHub Release sa asset-om `pokloni-plugin.zip`.
...
## 9. Changelog
- **1.5.0** — Jasniji prikaz odabranih proizvoda i uslova u adminu pre izmene.
